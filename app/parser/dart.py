...
class Parser:
    ...
    async def parse(assist: Assistant, item: AppSettingSoftItem):
        ...
        url, http_status_code, _, data_r = await assist.get('https://storage.googleapis.com/storage/v1/b/dart-archive/o',
                                                            params={'delimiter': '/', 'prefix': 'channels/stable/release/', 'alt': 'json'},
                                                            is_json=True)
