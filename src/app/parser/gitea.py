...
from app.core.config import GiteaSoftware
from app.core.version import VersionHelper
from . import Base


class Parser(Base):
    async def handle(self, sem: Semaphore, soft: GiteaSoftware):
        ...
        async with sem:
            ...
            if soft.release:
                ...
                api_url = f'https://{soft.host}/api/v1/repos/{soft.owner}/{soft.repo}/tags'
